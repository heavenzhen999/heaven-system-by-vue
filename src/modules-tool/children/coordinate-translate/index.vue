<template>
  <div class="module-coordinate-translate">
    ...
    <el-row>
      <el-col class="label" :offset="2" :span="6">
        <span>输入坐标系：</span>
      </el-col>
      <el-col :span="16">
    ...
    <el-row class="translate-single" v-show="isSingle">
    ...
    <el-row class="translate-numerous" v-show="!isSingle" >
      <el-col :offset="2" :span="8">
...
import CoordinateTranslate from './js/coordinate-translate.js'
export default {
  data() {
    return {
      CoorInfo: COORINFO,
