<template>
  <el-row class="module-EsriJSON-to-GeoJSON">
    ...
    <el-col :span="4">
      ...
      <el-button type="primary" size="mini" @click="transform">转换</el-button>
      <el-button type="primary" size="mini" @click="transformMin">转换(压缩)</el-button>
...
// const geojsonToArcGIS = require('@esri/arcgis-to-geojson-utils').
export default {
  data() {
    return {
      changeTitle: '转换',
